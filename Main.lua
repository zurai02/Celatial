...
-- Fallback to local service access if Config is missing or incomplete
if not Config or not Config.Services then
	Config = {
...
local UIS = Config.Services.UserInputService or game:GetService("UserInputService")
local TweenService = Config.TS or game:GetService("TweenService")
local Players = Config.PS or game:GetService("Players")
local CoreGui = Config.CG or game:GetService("CoreGui")
local Http = Config.HS or game:GetService("HttpService")
local Run = Config.RUN or game:GetService("RunService")
local TextService = Config.TXS or game:GetService("TextService")
...
local function safecall(fn, ...)
	...
	local ok, r = pcall(fn, ...)
	if not ok then 
		warn("[Celestial] Error: " .. tostring(r))
	end
